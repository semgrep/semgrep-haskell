...
(**
    Functions for parsing haskell programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a haskell program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.haskell, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a haskell program from a file into a typed OCaml CST.
